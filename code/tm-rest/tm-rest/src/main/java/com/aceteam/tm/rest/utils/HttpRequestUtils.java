...
public class HttpRequestUtils {
    ...
    /**
     * Getting information in a cookie
     * @param request
     * @param cookieName
     * @return
     */
    public static Cookie findCookie(HttpServletRequest request, String cookieName) {
        ...
        // Iterates through all cookies looking for user account information and logins
    ...
    public static String generateSign(Map<String, String> args) {
        ...
        log.debug("Generate a signed string:{}", strForSign);
