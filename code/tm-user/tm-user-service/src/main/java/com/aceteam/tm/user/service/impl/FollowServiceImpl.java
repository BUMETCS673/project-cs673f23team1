...
import com.aceteam.tm.user.persistence.entity.FollowPoExample;
import com.aceteam.tm.user.persistence.mapper.FollowPoMapper;
...
public class FollowServiceImpl implements FollowService {
    ...
    public PageInfo<FollowDTO> getFollowUsers(FollowSearchDTO followSearchDTO, UserSsoDTO currentUser) {
        ...
        pageInfo.getList().forEach(followDTO -> {
            ...
            followDTO.setReadCount(CollectionUtils.isEmpty(postReadDTOS) ? 0L : postReadDTOS.get(0).getPostReadCount());
