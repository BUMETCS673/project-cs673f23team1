  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    var Connect = {
      ...
      data: function data() {
        ...
        this.preProps = (0, _extends3['default'])({}, (0, _omit2['default'])((0, _propsUtil.getOptionProps)(this), ['__propsSymbol__']), this.injectExtraProps);
        return {
          subscribed: finalMapStateToProps(this.store.getState(), (0, _extends3['default'])({}, this.$props, this.injectExtraProps))
        };
      },
      ...
      watch: {
        __propsSymbol__: function __propsSymbol__() {
          if (mapStateToProps && mapStateToProps.length === 2) {
            this.subscribed = finalMapStateToProps(this.store.getState(), (0, _extends3['default'])({}, this.$props, this.injectExtraProps));
          }
        }
      },
      ...
      methods: {
        handleChange: function handleChange() {
          ...
          var props = (0, _extends3['default'])({}, (0, _omit2['default'])((0, _propsUtil.getOptionProps)(this), ['__propsSymbol__']), this.injectExtraProps);
      ...
      render: function render() {
        ...
        var props = (0, _extends3['default'])({}, (0, _propsUtil.getOptionProps)(this), this.injectExtraProps);
        this.preProps = (0, _extends3['default'])({}, (0, _omit2['default'])(props, ['__propsSymbol__']));
        var wrapProps = {
          props: (0, _extends3['default'])({}, props, subscribed, {
            store: store
          }),
          on: (0, _extends3['default'])({}, (0, _propsUtil.getListeners)(this), this.injectExtraListeners),
